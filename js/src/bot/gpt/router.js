...
**O3-mini:** Новейшая модель OpenAI с улучшенными возможностями рассуждения (данные до октября 2023)

**O1-preview:** Модель OpenAI с продвинутыми способностями к рассуждению (данные до октября 2023)
**O1-mini:** Более быстрая версия O1 для простых задач (данные до октября 2023)

**GPT-4o:** Многомодальная модель OpenAI с поддержкой текста и изображений (данные до октября 2023)
**GPT-4o-mini:** Быстрая и экономичная версия GPT-4o (данные до октября 2023)
**GPT-3.5-turbo:** Классическая модель OpenAI, хорошо подходит для базовых задач (данные до сентября 2021)

**Claude 3.7 Sonnet:** Самая современная модель Anthropic с новейшими данными (данные до ноября 2024)
**Claude 3.5 Sonnet:** Сбалансированная модель Anthropic (данные до апреля 2024)
**Claude 3.5 Haiku:** Быстрая модель Anthropic для простых задач (данные до июля 2024)
**Claude 3 Opus:** Самая мощная модель Claude 3 (данные до августа 2023)

**Llama 3.1 405B:** Крупнейшая модель Meta с 405B параметров (данные до декабря 2023)
**Llama 3.1 70B:** Сбалансированная модель Meta с 70B параметров (данные до декабря 2023)
**Llama 3.1 8B:** Быстрая модель Meta с 8B параметров (данные до декабря 2023)

**DeepSeek Chat:** Модель от DeepSeek для диалогов (данные до июля 2024)
**DeepSeek Reasoner:** Модель DeepSeek с улучшенными способностями к рассуждению (данные до июля 2024)`;
